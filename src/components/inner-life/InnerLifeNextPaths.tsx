...
export default function InnerLifeNextPaths({ data }: { data?: any }) {
  ...
  return (
    <section className="relative overflow-hidden bg-white py-24 transition-colors duration-500 dark:bg-stone-950 md:py-32">
